...
<head>
	...
	<title>Login - Electronic Filing System </title>
	<meta content="" name="description">
	<meta content="" name="keywords">

	<!-- Favicons -->
	<link href="<?= base_url('assets') ?>/assets/img/logo-bks.png" rel="icon">
	<link href="<?= base_url('assets') ?>/assets/img/logo-bks.png" rel="apple-touch-icon">
						...
						<div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
							...
							<div class="d-flex justify-content-center py-4">
								<a href="index.html" class="logo d-flex align-items-center w-auto">
									<!-- <img src="<?= base_url('assets') ?>/assets/img/logo-bks.png" alt=""> -->
									<!-- <span class="d-none d-lg-block">BKS</span> -->
								</a>
							</div><!-- End Logo -->
							...
							<div class="card mb-3">
								...
								<div class="card-body">
									...
									<div class="pt-4 pb-2">
										<h5 class="card-title text-center pb-0 fs-4">Electronic Filing System</h5>
										<p class="text-center small">PT. BRINGIN KARYA SEJAHTERA</p>
									</div>
									...
									<form class="row g-3 needs-validation" novalidate action="<?= site_url('auth/login') ?>" method="POST">
										...
										<div class="col-12">
											<p class="small mb-0">Belum memiliki akses ? <a href="#">Kontak Administrator</a></p>
										</div>
									</form>
