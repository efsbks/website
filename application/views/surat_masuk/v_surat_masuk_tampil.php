...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Electronic Filing System </h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <a href="<?= site_url() . "/" . $this->uri->segment('1') . "/surat_masuk/download/" . $surat->FILE_SURAT ?>"><button type="button" class="btn btn-info btn-sm"><i class="bi bi-arrow-down-square"></i> Download File1 </button></a>
